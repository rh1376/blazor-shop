...
using BitTodo.Server.Api.Resources;
using BitTodo.Server.Api.Models.Identity;
using BitTodo.Shared.Dtos.Identity;
using BitTodo.Server.Api.Models.Emailing;

namespace BitTodo.Server.Api.Controllers.Identity;
...
public partial class AuthController : AppControllerBase
{
    ...
    private async Task SendConfirmationEmail(SendConfirmationEmailRequestDto sendConfirmationEmailRequest, User user, CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("BitTodo.Server.Api.Resources.EmailConfirmation.cshtml",
        ...
        , CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("BitTodo.Server.Api.Resources.ResetPassword.cshtml",
