...
using BitTodo.Server.Api;
using BitTodo.Server.Api.Models.Identity;
using BitTodo.Server.Api.Services.Implementations;
...
public static class IServiceCollectionExtensions
{
    ...
    public static void AddSwaggerGen(this IServiceCollection services)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "BitTodo.Server.Api.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "BitTodo.Shared.xml"));
