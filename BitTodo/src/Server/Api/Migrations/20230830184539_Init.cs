...
namespace BitTodo.Server.Api.Migrations
{
    /// <inheritdoc />
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, new DateTimeOffset(new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 30, 0, 0)), "d93b37d5-6eb8-4726-8b22-5ed81c940b05", null, "test@bitplatform.dev", true, "BitTodo test account", 2, false, null, "TEST@BITPLATFORM.DEV", "TEST@BITPLATFORM.DEV", "AQAAAAIAAYagAAAAEITZqwnTi3Tn2onkEyHqIaoxGjX32xcLgP+ABU+kToKDIzZgXk6MxjiLKh/Nfgvy7w==", null, false, null, null, "9f08c4c2-0b57-4f02-b85e-84245748954c", false, "test@bitplatform.dev" });
