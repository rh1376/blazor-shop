using BitTodo.Client.Core.Shared;
#if BlazorWebAssembly
using Microsoft.AspNetCore.Components.WebAssembly.Hosting;
#endif

namespace BitTodo.Client.Web;
...
public partial class Program
{
    ...
    public static WebAssemblyHost CreateHostBuilder(string[] args)
    {
        ...
        builder.Configuration.AddJsonStream(typeof(MainLayout).Assembly.GetManifestResourceStream("BitTodo.Client.Core.appsettings.json")!);
